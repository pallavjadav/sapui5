sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("odata.EmployeeODATA.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias odata.EmployeeODATA.controller.ListSelector
			 */
			 ...
			 * @return {odata.EmployeeODATA.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
