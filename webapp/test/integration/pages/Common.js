sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("odata/EmployeeODATA/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#EmployeeODATA-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#EmployeeODATA-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("odata.EmployeeODATA.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["odata/EmployeeODATA/localService/mockserver"], function (mockserver) {
